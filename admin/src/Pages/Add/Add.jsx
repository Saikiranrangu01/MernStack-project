...
const Add = ({url}) => {
  ...
  const onSubmitHandler = async (event)=>{
    ...
    const response = await axios.post(`${url}/api/food/add`,formData); //formdata is added in database img stored in backend 
  ...
  return (
    <div className='add'>
      <form className='flex-col' onSubmit={onSubmitHandler}>
        ...
        <div className="add-prouduct-description flex-col">
